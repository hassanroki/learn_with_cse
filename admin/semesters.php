...
<div class="col-md-9 ps-3 overflow-hidden">
    <a href="semestersAdd.php" class="btn btn-info">+ Add New Semester</a>
        ...
        ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="semestersUpdate.php?id=<?php echo $row['id']; ?>" class="btn btn-info">Edit</a>
                            <a href="semestersStore.php?id=<?php echo $row['id']; ?>" class="btn btn-warning" onclick="return confirm('Are you sure?')">Delete</a>
                        </td>
                    </tr>
                </tbody>
        <?php
